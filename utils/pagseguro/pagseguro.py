...
class Pagseguro:
  ...
  def mostra(self, **kws):
    ...
    if data['botao']:
      input = '<input type="image" src="%s" name="submit" alt="Pague com PagSeguro - &eacute; r&acute;pido, gr&aacute;tis e seguro!" />"'
      if str == data['imgBotao']:
        ret.append(input % data['imgBotao'])
      input = '<input type="image" src="https://pagseguro.uol.com.br/Security/Imagens/%s.jpg" name="submit" alt="Pague com PagSeguro - &eacute; r&aacute;pido, gr&aacute;tis e seguro!" />'
      if data['imgBotao'] == 1:
