...
class PayPal:
    ...
    def __init__(self):
        ...
        'USER' : 'lcn.an_1328673680_biz_api1.gmail.com', # Edit this to your API user name
        'PWD' : '1328673704', # Edit this to your API password
        'SIGNATURE' : 'AN7VSxv7gZ3t24KBCfTauA2qg6ekA5SptP8dMmn8CuIF4WzAS-VzbAO1', # edit this to your API signature
        'VERSION' : '53.0',
        }
